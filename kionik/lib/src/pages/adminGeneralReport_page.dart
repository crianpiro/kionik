...
class AdminGeneralReportPage extends StatefulWidget {
  static final route = "adminGeneralReport";
  @override
  _AdminGeneralReportPageState createState() => _AdminGeneralReportPageState();
}

class _AdminGeneralReportPageState extends State<AdminGeneralReportPage> {
  DateTime date = DateTime.now();

  String dateSearch = "Seleccione una fecha";
  ...
  Widget _buildBody(Size size) {
    return ListView(
      children: <Widget>[
        buildButton(size, 'Selecciona fecha', () {
          _selectDate(context);
        }),
        Row(
          children: <Widget>[
        ...
        (_search) ? _buildSelector(size) : Container(),
      ],
    );
  }
          ...
          if (snapshot.hasData) {
            ...
            body.forEach((id, item) {
              items.add(
                ...
                child:buildLabel(item['name'], size),)
              );
              items.add(_buildProgressInfo(size, id));
            });
            return Column(
              children: items,
            );
  ...
  Widget _buildProgressInfo(Size size, String uidEmployer) {
    return FutureBuilder(
